...
figlet k3p1t1n9  | lolcat

echo -b "_____________________________________________________________" | lolcat
echo -b "TYPE      : k3p1t1n9 TOOLS INSTALLER $green " |lolcat
echo -b "VERSION   : V.3 " | lolcat
echo -b "TOTALS    : 311 k3p1t1n9 TOOLS " | lolcat
echo -b "AUTHOR    : KEPITING $green " |lolcat
...
echo -b "NOTES     : JELAJAHI SETIAP k3p1t1n9 TOOLS DENGAN BIJAK " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
ctrl_c() {
clear
echo -b $green"[#]> K3p1t1n9 TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY k3p1t1n9 TOOLS GUA " |lolcat
echo -b $green"[#]> Thanks For Using My Tools" |lolcat
sleep 1
echo -b $green"[#]> k3p1t1n9 On Your System" |lolcat

echo -b $green"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet KEPITING | lolcat
sleep 1
exit
}
...
echo -e "######################################" | lolcat
echo -e "#SILAHKAN TUNGGU DAN LIHAT LIST k3p1t1n9 TOOLS#" | lolcat
echo -e "######################################" | lolcat
...
00) echo "AUTHOR: k3p1t1n9" | lolcat
echo "KEPITING ON YOUR SYSTEM" | lolcat
echo "INDONESIAN TERMUX ASSOCIATION" | lolcat
echo "SEMUA TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY k3p1t1n9 TOOLS GUA" | lolcat
figlet KEPITING | lolcat
exit
;;
